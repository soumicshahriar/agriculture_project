  ...
  <script>
    ...
    const demandChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Quantity Sold', // Label for the dataset
          data: quantities, // Total quantities sold for each product
          backgroundColor: ['gray', 'black', 'red', 'orange', '#FF9F40', '#C7B9F1', '#FF5757'], // Colors for each bar
      ...
      options: {
        ...
        scales: {
          y: {
            ...
            ticks: {
              stepSize: 10, // Adjust step size for Y-axis ticks
              font: {
              ...
              color: '#333', // Color of Y-axis ticks
            }
          },
          x: {
            ticks: {
              ...
              color: '#333', // Color of X-axis ticks
            }
          }
        },
        plugins: {
