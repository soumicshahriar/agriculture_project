...
<head>
    ...
    <link rel="stylesheet" href="/admin_db/historicalData/historical_data.css">
        ...
        const demandChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0', '#FF9F40', '#C7B9F1', '#FF5757'], // Colors for each slice
